...
/*   Updated: 2021/01/30 02:29:33 by smun             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_bool			device_window_init(t_game *g, t_bool has_window)
{
	...
	mlx_hook(g->win_ptr, HookEvent_CloseWindow, 0, &window_on_close, g);
	mlx_hook(g->win_ptr, HookEvent_Expose, 0, &window_on_expose, g);
	return (TRUE);
}
